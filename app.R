...
server <- function(input, output) {
  ...
  observeEvent(input$go, {
    ...
    file.rename(from="/home/jovyan/geckodriver-v0.32.0-linux64.tar",to="/home/jovyan/.local/share/binman_geckodriver/linux64/0.32.0/geckodriver-v0.32.0-linux64.tar")
